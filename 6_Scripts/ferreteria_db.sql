...
CREATE TABLE IF NOT EXISTS `ferreteria`.`categorias` (
  `id` INT NOT NULL COMMENT 'Identificador único de cada categoría en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`personas` (
  `id` INT NOT NULL COMMENT 'Identificador único de cada persona en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`clientes` (
  `id` INT NOT NULL COMMENT 'Identificador único del cliente en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`ciudades` (
  `id` INT NOT NULL COMMENT 'Identificador único de la ciudad en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`sucursales` (
  `id` INT NOT NULL COMMENT 'Identificador único de la sucursal en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`empleados` (
  `id` INT NOT NULL COMMENT 'Identificador único del empleado en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`marcas` (
  `id` INT NOT NULL COMMENT 'Identificador único de la marca en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`proveedores` (
  `id` INT NOT NULL COMMENT 'Identificador único del proveedor en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`productos` (
  `id` INT NOT NULL COMMENT 'Identificador único del producto en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`pedidos` (
  `id` INT NOT NULL COMMENT 'Identificador único del pedido en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`detalle_pedido` (
  `id` INT NOT NULL COMMENT 'Identificador único del detalle sobre el pedido en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`ventas` (
  `id` INT NOT NULL COMMENT 'Identificador único de la venta realizada y enviada en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`detalle_venta` (
  `id` INT NOT NULL COMMENT 'Identificador único del detalle de la venta realizada y enviada en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`devoluciones` (
  `id` INT NOT NULL COMMENT 'Identificador único de la devolucion en la base de datos. Se genera automáticamente.',
...
CREATE TABLE IF NOT EXISTS `ferreteria`.`usuarios` (
  `id` INT NOT NULL COMMENT 'Identificador único del usuario en la base de datos. Se genera automáticamente.',
